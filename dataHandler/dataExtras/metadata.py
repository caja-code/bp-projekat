...
class MetaData:
    def __init__(self, metadata_path, data_path_c):
    ...
    '''def _get_data_headers(self):
        dialect = self._get_dialect()
        return self._get_data_headers(dialect)'''

    # TODO: namesttiti da _make_blank_metadata,_get_dialect, _get_data_headers rade i staticke metode

#p = Path("/home/igork/singi/BazePodataka-S1G1/bp-projekat/podaci/hw_25000.csv")
#c = MetaData(p.get_metadata_path(), p)
